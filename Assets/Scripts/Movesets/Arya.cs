...
// Deals MASSSIVE damage, but causes 20% of hp recoil damage to the user
...
public static class Arya
{
    public static List<Move> moves = new List<Move>() {
		...
		new Move() {
			moveName = "Shudh Dudh",
            moveDesc = "Pulls out his 2 Litre bottle of pure buffallo milk and drinks it one gulp, ATK and DEF up by 1 stage.",
		...
		new Move() {
			moveName = "Puppy Eyes",
			moveDesc = "Says \"Aisa karega mere saath\" in a very sweet voice, Lowers ATK of opponent by one stage.",
		...
		new Move() { 
			...
			moveDesc = "Straightforward move where he uses his badminton racket to attack the opponent, deals moderate damage to opponent.",
		...
		new Move() {
			...
			moveDesc = " Calls upon the Jaat gang of IITK using his Feminine Jaat powers, Deals MASSSIVE damage, but causes 20% recoil damage to the user.",
